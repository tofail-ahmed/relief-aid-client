...
const Counter = () => {
  return (
    <div className="bg-orange-500">
      <Container className="flex lg:flex-row flex-col justify-around py-10 font-bold">
      <div className=" text-white flex flex-col justify-center items-center space-y-2">
       <span className="text-6xl"> <FaHandsHoldingChild /></span>
      ...
      <div className=" text-white flex flex-col justify-center items-center space-y-2">
       <span className="text-6xl"> <FaHandHoldingHeart />
 </span>
        <span className="text-6xl">
      ...
      <div className=" text-white flex flex-col justify-center items-center space-y-2">
       <span className="text-6xl"> <AiOutlineGlobal /></span>
        <span className="text-6xl">
      ...
      <div className=" text-white flex flex-col justify-center items-center space-y-2">
       <span className="text-6xl"> <FaDonate  /></span>
        <span className="text-6xl">
