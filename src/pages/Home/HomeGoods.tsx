...
const HomeGoods = () => {
  ...
  return (
    ...
    <div className="flex justify-center">
      <NavLink  onClick={scrollToTop} className="bg-orange-500 hover:bg-slate-500 text-lg  hover:text-white rounded-md px-2 py-1 my-4 duration-500" to={'/relief-goods'}>See All</NavLink>
    </div>
    </div>
  )
}
